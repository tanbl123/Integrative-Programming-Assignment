...
class Location extends Model
{
    ...
    public static function search(string $query = ''): array
    {
        ...
        $rows = Database::getInstance()->selectAll(
            ...
            . ' WHERE deleted_at IS NULL AND (location_name LIKE ? OR building_name LIKE ? OR floor_no LIKE ?)'
    ...
    public static function allAlphabetical(): array
    {
        return self::hydrateAll(Database::getInstance()->selectAll(
            'SELECT * FROM locations WHERE deleted_at IS NULL ORDER BY building_name, floor_no, location_name'
        ));
    }
